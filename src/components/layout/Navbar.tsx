...
export function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-50 w-full bg-white/80 backdrop-blur-xl border-b border-blue-100/50 dark:bg-slate-900/80 dark:border-slate-700/50">
        <div className="container mx-auto px-4">
          <div className="flex h-20 items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="relative">
                ...
                <div className="relative rounded-2xl bg-gradient-primary p-3 group-hover:scale-110 transition-transform duration-300 btn-hover-glow">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                className="relative rounded-2xl hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 btn-hover-lift"
              >
          ...
          {/* Mobile Navigation */}
          {mobileMenuOpen && (
            <div className="md:hidden py-6 space-y-3 animate-slide-up bg-white/90 backdrop-blur-xl rounded-2xl mb-4 border border-blue-100/50">
              {navigation.map((item, index) => (
                <Link
                  key={item.name}
                  to={item.href}
